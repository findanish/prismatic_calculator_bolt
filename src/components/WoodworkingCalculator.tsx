...
const getItemColor = (itemName: string, isDark: boolean = false): string => {
  ...
  if (itemName.includes('Aged Wood')) return '#DEB887'; // Light Brown
  ...
  if (itemName.includes('Prismatic')) return '#8B4513';
  if (itemName.includes('Obsidian Sandpaper')) return '#F5DEB3'; // Creamish Yellow
  if (itemName.includes('Wildwood')) return '#DEA5A4'; // Pinkish Brown
  return '#666666';
};
...
export function WoodworkingCalculator() {
